...
💻 Build fullstack applications using React, Next.js, Node.js, Express, Python, Django

📊 Work with data analytics, machine learning, and predictive modeling

🌍 Conduct research in climate change, environmental geology, and AI applications
...
📚 17+ published research papers

🎤 15+ conference presentations

🧪 Experience with ML models, data pipelines, and analytics tools
...
Data/ML: Pandas, NumPy, Scikit-learn, TensorFlow, Data Visualization

🌱 Current Focus

Building scalable web applications

Machine learning for environmental and industrial systems

Expanding global auto export business (PrimeShift Auto)

Developing AgroLink Hub – a digital agriculture innovation
